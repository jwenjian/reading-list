      ...
      <body>
        ...
        <div class="head inner">
          ...
          <div class="head_main">
            ...
            <a class="head_link" target="_blank" href="https://wj.qq.com/s2/9175643/5dfb/">
              提交链接 &#x2192;
            </a>
          </div>
        </div>
        ...
        <div class="typlog-foot">
          <a class="title" href="#">@2021</a>
          <nav>
            <a href="https://github.com/jwenjian">GitHub (@jwenjian)</a>
          </nav>
        </div>
      </body>
    </html>
